...
export default function OfficesSection({ officesData }: OfficesSectionProps) {
    ...
    return (
        <section
            ...
            md:flex-row gap-8 items-center overflow-hidden md:h-[950px]"
                ...
                <div className="w-full  md:w-1/4 space-y-6 z-10">
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            text-lg hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2 focus:ring-white
                        ...
                        <button
                            ...
                            className="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center
                            text-lg hover:bg-gray-100 transition-colors focus:outline-none focus:ring-2
